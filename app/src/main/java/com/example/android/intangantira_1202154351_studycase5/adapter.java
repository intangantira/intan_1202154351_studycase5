...
public class adapter extends RecyclerView.Adapter<adapter.holder> {
    ...
    //konstruktor
    public adapter(Context con, List<addData> list, int color){
        this.con=con;
        this.list=list;
        this.color=color;
    }
    ...
    public holder onCreateViewHolder(ViewGroup parent, int viewType) {
        //membuat view baru
        View view = LayoutInflater.from(con).inflate(R.layout.cardview, parent, false);
    ...
    public void onBindViewHolder(holder holder, int position) {
        ...
        holder.cardv.setCardBackgroundColor(con.getResources().getColor(this.color));
    }
